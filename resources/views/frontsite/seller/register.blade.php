    ...
    <div class="bg-white rounded-xl p-2 md:p-4 lg:p-6 shadow-sm drop-shadow-md">
        <div class="flex space-x-0 md:space-x-8 lg:space-x-10 px-4 md:px-10">
            ...
            <div class="w-full md:w-1/2 flex flex-col space-y-4 md:space-y-6 items-center">
                <p class="text-indigo-800 font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl">Daftar sebagai seller
                    Lapakita</p>
                <div class="bg-white shadow drop-shadow rounded-xl w-full">
                    <form class="p-4 flex flex-col space-y-4" method="POST" action="{{ route('seller.daftar') }}">
                        @csrf
                        <div class="flex flex-col">
                            <label class="text-gray-700 text-xs md:text-[10pt] font-medium">Nama Toko</label>
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('seller.login') }}" class="text-xs md:text-sm text-sky-600">Masuk</a>
                </div>
            </div>
        </div>
    </div>
